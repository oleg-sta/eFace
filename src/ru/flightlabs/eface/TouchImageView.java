...
import static ru.flightlabs.eface.TouchImageView.State.ANIMATE_ZOOM;
import static ru.flightlabs.eface.TouchImageView.State.DRAG;
import static ru.flightlabs.eface.TouchImageView.State.FLING;
import static ru.flightlabs.eface.TouchImageView.State.NONE;
import static ru.flightlabs.eface.TouchImageView.State.ZOOM;
...
public class TouchImageView extends ImageView {
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            if (externalScaleListener != null) {
                externalScaleListener.onScaleEnd(getCurrentZoom());
            }
