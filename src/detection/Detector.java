...
public class Detector {
    ...
    public static Detector create(InputStream inputXml) {
        /* Read XML file */
        org.jdom.Document document = null;
        SAXBuilder sxb = new SAXBuilder();
        try {
            document = sxb.build(inputXml);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return new Detector(document);
     ...
     *         pixels.
     */
    // public List<Rectangle> getFaces(Bitmap image,float baseScale, float
    // scale_inc,float increment, int min_neighbors,boolean doCannyPruning)
    // {
    // try {
    // //BufferedImage image = ImageIO.read(new File(file));
    // return getFaces(image, baseScale, scale_inc, increment, min_neighbors,
    // doCannyPruning);
    // } catch (IOException e) {
    // e.printStackTrace();
    // }
